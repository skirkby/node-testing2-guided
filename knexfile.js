...
// "development", and another one called "testing". These contain
// options/settings/configuration for a specific environment, allowing us to
...
// 
// In our example, there, we are setting DB_ENV to "testing" using cross-env.
