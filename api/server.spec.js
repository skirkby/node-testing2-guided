...
// parallel would fail, because it would try to start the server listening
// again. Each test execution is in its own environment, so each one needs its
// own copy of Express. We can't have Express start up on the same port for each
// of them, because only one instance can use any given port. 
//
...
describe('server.js', () => {
    ...
    describe('GET /', () => {
        ...
        // the superagent part of supertest can have something to send a request
        // to. It starts Express on an ephemeral port. (Are you tired of me
        // saying "ephemeral"? I predict you will legit use it in a sentence
        // this week.)
        //
